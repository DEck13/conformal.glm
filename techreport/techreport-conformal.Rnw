...
for(j in shapes ){
  ...
  LS.marginal.misspec.150[k] <- as.numeric(internal.output[2, 1])
  LSLW.marginal.misspec.150[k] <- as.numeric(internal.output[3, 1])
  nonpara.marginal.misspec.150[k] <- as.numeric(internal.output[4, 1])
  para.marginal.misspec.150[k] <- as.numeric(internal.output[5, 1])
  transform.marginal.misspec.150[k] <- as.numeric(internal.output[6, 1])
  trueHD.marginal.misspec.150[k] <- as.numeric(internal.output[7, 1])

  # local coverages
  HD.local.misspec.150[(2*k-1):(2*k)] <- as.numeric(internal.output[1, 2:3])
  LS.local.misspec.150[(2*k-1):(2*k)] <- as.numeric(internal.output[2, 2:3])
  LSLW.local.misspec.150[(2*k-1):(2*k)] <- as.numeric(internal.output[3, 2:3])
  nonpara.local.misspec.150[(2*k-1):(2*k)] <- as.numeric(internal.output[4, 2:3])
  para.local.misspec.150[(2*k-1):(2*k)] <- as.numeric(internal.output[5, 2:3])
  transform.local.misspec.150[(2*k-1):(2*k)] <- as.numeric(internal.output[6, 2:3])
  trueHD.local.misspec.150[(2*k-1):(2*k)] <- as.numeric(internal.output[7, 2:3])

  # conditional coverages
  HD.inx.misspec.150[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[1, 4:28])
  LS.inx.misspec.150[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[2, 4:28])
  LSLW.inx.misspec.150[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[3, 4:28])
  nonpara.inx.misspec.150[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[4, 4:28])
  para.inx.misspec.150[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[5, 4:28])
  transform.inx.misspec.150[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[6, 4:28])
  trueHD.inx.misspec.150[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[7, 4:28])

  # area
  HD.area.misspec.150[k] <- as.numeric(internal.output[1, 29])
  LS.area.misspec.150[k] <- as.numeric(internal.output[2, 29])
  LSLW.area.misspec.150[k] <- as.numeric(internal.output[3, 29])
  nonpara.area.misspec.150[k] <- as.numeric(internal.output[4, 29])
  para.area.misspec.150[k] <- as.numeric(internal.output[5, 29])
  transform.area.misspec.150[k] <- as.numeric(internal.output[6, 29])
  trueHD.area.misspec.150[k] <- as.numeric(internal.output[7, 29])

  # prediction error
  HD.error.misspec.150[k] <- as.numeric(internal.output[1, 30])
  LS.error.misspec.150[k] <- as.numeric(internal.output[2, 30])
  LSLW.error.misspec.150[k] <- as.numeric(internal.output[3, 30])
  nonpara.error.misspec.150[k] <- as.numeric(internal.output[4, 30])
  para.error.misspec.150[k] <- as.numeric(internal.output[5, 30])
  transform.error.misspec.150[k] <- as.numeric(internal.output[6, 30])
  trueHD.error.misspec.150[k] <- as.numeric(internal.output[7, 30])  
}
@
...
for(j in shapes ){
  ...
  LS.marginal.misspec.250[k] <- as.numeric(internal.output[2, 1])
  LSLW.marginal.misspec.250[k] <- as.numeric(internal.output[3, 1])
  nonpara.marginal.misspec.250[k] <- as.numeric(internal.output[4, 1])
  para.marginal.misspec.250[k] <- as.numeric(internal.output[5, 1])
  transform.marginal.misspec.250[k] <- as.numeric(internal.output[6, 1])
  trueHD.marginal.misspec.250[k] <- as.numeric(internal.output[7, 1])

  # local coverages
  HD.local.misspec.250[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[1, 2:4])
  LS.local.misspec.250[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[2, 2:4])
  LSLW.local.misspec.250[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[3, 2:4])
  nonpara.local.misspec.250[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[4, 2:4])
  para.local.misspec.250[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[5, 2:4])
  transform.local.misspec.250[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[6, 2:4])
  trueHD.local.misspec.250[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[7, 2:4])

  # conditional coverages
  HD.inx.misspec.250[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[1, 5:29])
  LS.inx.misspec.250[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[2, 5:29])
  LSLW.inx.misspec.250[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[3, 5:29])
  nonpara.inx.misspec.250[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[4, 5:29])
  para.inx.misspec.250[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[5, 5:29])
  transform.inx.misspec.250[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[6, 5:29])
  trueHD.inx.misspec.250[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[7, 5:29])

  # area
  HD.area.misspec.250[k] <- as.numeric(internal.output[1, 30])
  LS.area.misspec.250[k] <- as.numeric(internal.output[2, 30])
  LSLW.area.misspec.250[k] <- as.numeric(internal.output[3, 30])
  nonpara.area.misspec.250[k] <- as.numeric(internal.output[4, 30])
  para.area.misspec.250[k] <- as.numeric(internal.output[5, 30])
  transform.area.misspec.250[k] <- as.numeric(internal.output[6, 30])
  trueHD.area.misspec.250[k] <- as.numeric(internal.output[7, 30])

  # prediction error
  HD.error.misspec.250[k] <- as.numeric(internal.output[1, 31])
  LS.error.misspec.250[k] <- as.numeric(internal.output[2, 31])
  LSLW.error.misspec.250[k] <- as.numeric(internal.output[3, 31])
  nonpara.error.misspec.250[k] <- as.numeric(internal.output[4, 31])
  para.error.misspec.250[k] <- as.numeric(internal.output[5, 31])
  transform.error.misspec.250[k] <- as.numeric(internal.output[6, 31])
  trueHD.error.misspec.250[k] <- as.numeric(internal.output[7, 31])  
}
@
...
for(j in shapes ){
  ...
  LS.marginal.misspec.500[k] <- as.numeric(internal.output[2, 1])
  LSLW.marginal.misspec.500[k] <- as.numeric(internal.output[3, 1])
  nonpara.marginal.misspec.500[k] <- as.numeric(internal.output[4, 1])
  para.marginal.misspec.500[k] <- as.numeric(internal.output[5, 1])
  transform.marginal.misspec.500[k] <- as.numeric(internal.output[6, 1])
  trueHD.marginal.misspec.500[k] <- as.numeric(internal.output[7, 1])

  # local coverages
  HD.local.misspec.500[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[1, 2:4])
  LS.local.misspec.500[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[2, 2:4])
  LSLW.local.misspec.500[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[3, 2:4])
  nonpara.local.misspec.500[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[4, 2:4])
  para.local.misspec.500[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[5, 2:4])
  transform.local.misspec.500[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[6, 2:4])
  trueHD.local.misspec.500[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[7, 2:4])

  # conditional coverages
  HD.inx.misspec.500[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[1, 5:29])
  LS.inx.misspec.500[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[2, 5:29])
  LSLW.inx.misspec.500[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[3, 5:29])
  nonpara.inx.misspec.500[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[4, 5:29])
  para.inx.misspec.500[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[5, 5:29])
  transform.inx.misspec.500[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[6, 5:29])
  trueHD.inx.misspec.500[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[7, 5:29])

  # area
  HD.area.misspec.500[k] <- as.numeric(internal.output[1, 30])
  LS.area.misspec.500[k] <- as.numeric(internal.output[2, 30])
  LSLW.area.misspec.500[k] <- as.numeric(internal.output[3, 30])
  nonpara.area.misspec.500[k] <- as.numeric(internal.output[4, 30])
  para.area.misspec.500[k] <- as.numeric(internal.output[5, 30])
  transform.area.misspec.500[k] <- as.numeric(internal.output[6, 30])
  trueHD.area.misspec.500[k] <- as.numeric(internal.output[7, 30])

  # prediction error
  HD.error.misspec.500[k] <- as.numeric(internal.output[1, 31])
  LS.error.misspec.500[k] <- as.numeric(internal.output[2, 31])
  LSLW.error.misspec.500[k] <- as.numeric(internal.output[3, 31])
  nonpara.error.misspec.500[k] <- as.numeric(internal.output[4, 31])
  para.error.misspec.500[k] <- as.numeric(internal.output[5, 31])
  transform.error.misspec.500[k] <- as.numeric(internal.output[6, 31])
  trueHD.error.misspec.500[k] <- as.numeric(internal.output[7, 31])  
}
@
...
plot.window(xlim = c(log(min(shapes)), log(max(shapes))), 
  ylim = c(0, 0.60))
legend(-0.25, 0.55, legend=c("miss bin param", "miss transform param", 
...
plot.window(xlim = c(log(min(shapes)), log(max(shapes))), 
  ylim = c(0, 0.60))
legend(-0.25, 0.55, legend=c("miss bin param", "miss transform", 
...
plot.new()
plot.window(xlim = c(0, 1), ylim = c(0, 0.60))
legend(-0.25, 0.55, legend=c("miss bin param", 
  "bin nonparam", "LSLW", "LS", "true HD", "nominal coverage"), 
  col=c("red", "red", "green", "purple", "black", "blue", "grey"), 
  cex = 1.25, lty=c(1,2,2,1,2,4,1), bty = "n")
