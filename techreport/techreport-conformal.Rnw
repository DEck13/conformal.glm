...
\citep{tibshirani2016conformalR}.  
...
Four of the five prediction regions considered for this data are depicted in 
Figure~\ref{Fig:plots}.  The top row depicts the transformation parametric 
conformal prediction region (left panel) and the binned parametric conformal 
prediction region (right panel).  The bottom row depicts the binned 
nonparametric conformal prediction region (left panel) and the LSLW conformal 
prediction region (right panel).  The bin width was specified as 1/3 for the 
binned conformal prediction regions.  We see that the binned parametric 
conformal prediction region is a close discretization of the transformation 
conformal prediction region, the nonparametric conformal prediction region is 
quite jagged and unnatural, and the LSLW conformal prediction region includes 
...
para.area.gamma.150 <- nonpara.area.gamma.150 <- 
  ...
  HD.area.gamma.150 <- transform.area.gamma.150 <- NULL
para.error.gamma.150 <- nonpara.error.gamma.150 <- 
  LS.error.gamma.150 <- LSLW.error.gamma.150 <- 
  HD.error.gamma.150 <- transform.error.gamma.150 <- NULL
para.marginal.gamma.150 <- nonpara.marginal.gamma.150 <- 
  LS.marginal.gamma.150 <- LSLW.marginal.gamma.150 <- 
  HD.marginal.gamma.150 <- transform.marginal.gamma.150 <- NULL
para.local.gamma.150 <- nonpara.local.gamma.150 <- 
  LS.local.gamma.150 <- LSLW.local.gamma.150 <- 
  HD.local.gamma.150 <- transform.local.gamma.150 <- NULL
para.inx.gamma.150 <- nonpara.inx.gamma.150 <- 
  LS.inx.gamma.150 <- LSLW.inx.gamma.150 <- 
  HD.inx.gamma.150 <- transform.inx.gamma.150 <- NULL  
#shapes <- c(0.5, 0.75, 1, 1.5, 2, 5, 7, 10, 12, 15, 20, 25, 
#  30, 40, 50, 60, 70, 80, 90, 100)
shapes <- c(0.5, 1, 1.5, 2, 5, 7, 10, 12, 15, 20, 25, 
  30, 40, 50, 60, 70, 80, 90, 100)
for(j in shapes ){
  internal.output <- eval(parse(text=paste("diagnostics.150.2", j, sep = ".")))
  k <- which(shapes == j)

  # marginal coverages
  HD.marginal.gamma.150[k] <- as.numeric(internal.output[1, 1])
  LS.marginal.gamma.150[k] <- as.numeric(internal.output[2, 1])
  LSLW.marginal.gamma.150[k] <- as.numeric(internal.output[3, 1])
  nonpara.marginal.gamma.150[k] <- as.numeric(internal.output[4, 1])
  para.marginal.gamma.150[k] <- as.numeric(internal.output[5, 1])
  transform.marginal.gamma.150[k] <- as.numeric(internal.output[6, 1])
  
  # local coverages
  HD.local.gamma.150[(2*k-1):(2*k)] <- as.numeric(internal.output[1, 2:3])
  LS.local.gamma.150[(2*k-1):(2*k)] <- as.numeric(internal.output[2, 2:3])
  LSLW.local.gamma.150[(2*k-1):(2*k)] <- as.numeric(internal.output[3, 2:3])
  nonpara.local.gamma.150[(2*k-1):(2*k)] <- as.numeric(internal.output[4, 2:3])
  para.local.gamma.150[(2*k-1):(2*k)] <- as.numeric(internal.output[5, 2:3])
  transform.local.gamma.150[(2*k-1):(2*k)] <- as.numeric(internal.output[6, 2:3])
  
  # conditional coverages
  HD.inx.gamma.150[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[1, 4:28])
  LS.inx.gamma.150[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[2, 4:28])
  LSLW.inx.gamma.150[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[3, 4:28])
  nonpara.inx.gamma.150[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[4, 4:28])
  para.inx.gamma.150[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[5, 4:28])
  transform.inx.gamma.150[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[6, 4:28])

  # area
  HD.area.gamma.150[k] <- as.numeric(internal.output[1, 29])
  LS.area.gamma.150[k] <- as.numeric(internal.output[2, 29])
  LSLW.area.gamma.150[k] <- as.numeric(internal.output[3, 29])
  nonpara.area.gamma.150[k] <- as.numeric(internal.output[4, 29])
  para.area.gamma.150[k] <- as.numeric(internal.output[5, 29])
  transform.area.gamma.150[k] <- as.numeric(internal.output[6, 29])

  # prediction error
  HD.error.gamma.150[k] <- as.numeric(internal.output[1, 30])
  LS.error.gamma.150[k] <- as.numeric(internal.output[2, 30])
  LSLW.error.gamma.150[k] <- as.numeric(internal.output[3, 30])
  nonpara.error.gamma.150[k] <- as.numeric(internal.output[4, 30])
  para.error.gamma.150[k] <- as.numeric(internal.output[5, 30])
  transform.error.gamma.150[k] <- as.numeric(internal.output[6, 30])  
}
@
...
para.area.gamma.250 <- nonpara.area.gamma.250 <- 
  ...
  HD.area.gamma.250 <- transform.area.gamma.250 <- NULL
para.error.gamma.250 <- nonpara.error.gamma.250 <- 
  LS.error.gamma.250 <- LSLW.error.gamma.250 <- 
  HD.error.gamma.250 <- transform.error.gamma.250 <- NULL
para.marginal.gamma.250 <- nonpara.marginal.gamma.250 <- 
  LS.marginal.gamma.250 <- LSLW.marginal.gamma.250 <- 
  HD.marginal.gamma.250 <- transform.marginal.gamma.250 <- NULL
para.local.gamma.250 <- nonpara.local.gamma.250 <- 
  LS.local.gamma.250 <- LSLW.local.gamma.250 <- 
  HD.local.gamma.250 <- transform.local.gamma.250 <- NULL
para.inx.gamma.250 <- nonpara.inx.gamma.250 <- 
  LS.inx.gamma.250 <- LSLW.inx.gamma.250 <- 
  HD.inx.gamma.250 <- transform.inx.gamma.250 <- NULL  
shapes <- c(0.5, 0.75, 1, 1.5, 2, 5, 7, 10, 12, 15, 20, 25)
for(j in shapes ){
  internal.output <- eval(parse(text=paste("diagnostics.250.3", j, sep = ".")))
  k <- which(shapes == j)

  # marginal coverages
  HD.marginal.gamma.250[k] <- as.numeric(internal.output[1, 1])
  LS.marginal.gamma.250[k] <- as.numeric(internal.output[2, 1])
  LSLW.marginal.gamma.250[k] <- as.numeric(internal.output[3, 1])
  nonpara.marginal.gamma.250[k] <- as.numeric(internal.output[4, 1])
  para.marginal.gamma.250[k] <- as.numeric(internal.output[5, 1])
  transform.marginal.gamma.250[k] <- as.numeric(internal.output[6, 1])
  
  # local coverages
  HD.local.gamma.250[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[1, 2:4])
  LS.local.gamma.250[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[2, 2:4])
  LSLW.local.gamma.250[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[3, 2:4])
  nonpara.local.gamma.250[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[4, 2:4])
  para.local.gamma.250[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[5, 2:4])
  transform.local.gamma.250[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[6, 2:4])
  
  # conditional coverages
  HD.inx.gamma.250[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[1, 5:29])
  LS.inx.gamma.250[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[2, 5:29])
  LSLW.inx.gamma.250[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[3, 5:29])
  nonpara.inx.gamma.250[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[4, 5:29])
  para.inx.gamma.250[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[5, 5:29])
  transform.inx.gamma.250[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[6, 5:29])

  # area
  HD.area.gamma.250[k] <- as.numeric(internal.output[1, 30])
  LS.area.gamma.250[k] <- as.numeric(internal.output[2, 30])
  LSLW.area.gamma.250[k] <- as.numeric(internal.output[3, 30])
  nonpara.area.gamma.250[k] <- as.numeric(internal.output[4, 30])
  para.area.gamma.250[k] <- as.numeric(internal.output[5, 30])
  transform.area.gamma.250[k] <- as.numeric(internal.output[6, 30])

  # prediction error
  HD.error.gamma.250[k] <- as.numeric(internal.output[1, 31])
  LS.error.gamma.250[k] <- as.numeric(internal.output[2, 31])
  LSLW.error.gamma.250[k] <- as.numeric(internal.output[3, 31])
  nonpara.error.gamma.250[k] <- as.numeric(internal.output[4, 31])
  para.error.gamma.250[k] <- as.numeric(internal.output[5, 31])
  transform.error.gamma.250[k] <- as.numeric(internal.output[6, 31])  
}
@
...
para.area.gamma.500 <- nonpara.area.gamma.500 <- 
  ...
  HD.area.gamma.500 <- transform.area.gamma.500 <- NULL
para.error.gamma.500 <- nonpara.error.gamma.500 <- 
  LS.error.gamma.500 <- LSLW.error.gamma.500 <- 
  HD.error.gamma.500 <- transform.error.gamma.500 <- NULL
para.marginal.gamma.500 <- nonpara.marginal.gamma.500 <- 
  LS.marginal.gamma.500 <- LSLW.marginal.gamma.500 <- 
  HD.marginal.gamma.500 <- transform.marginal.gamma.500 <- NULL
para.local.gamma.500 <- nonpara.local.gamma.500 <- 
  LS.local.gamma.500 <- LSLW.local.gamma.500 <- 
  HD.local.gamma.500 <- transform.local.gamma.500 <- NULL
para.inx.gamma.500 <- nonpara.inx.gamma.500 <- 
  LS.inx.gamma.500 <- LSLW.inx.gamma.500 <- 
  HD.inx.gamma.500 <- transform.inx.gamma.500 <- NULL  
shapes <- c(0.5, 0.75, 1, 1.5, 2, 5, 7, 10, 12, 15, 20, 25)
for(j in shapes ){
  internal.output <- eval(parse(text=paste("diagnostics.500.3", j, sep = ".")))
  k <- which(shapes == j)

  # marginal coverages
  HD.marginal.gamma.500[k] <- as.numeric(internal.output[1, 1])
  LS.marginal.gamma.500[k] <- as.numeric(internal.output[2, 1])
  LSLW.marginal.gamma.500[k] <- as.numeric(internal.output[3, 1])
  nonpara.marginal.gamma.500[k] <- as.numeric(internal.output[4, 1])
  para.marginal.gamma.500[k] <- as.numeric(internal.output[5, 1])
  transform.marginal.gamma.500[k] <- as.numeric(internal.output[6, 1])
  
  # local coverages
  HD.local.gamma.500[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[1, 2:4])
  LS.local.gamma.500[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[2, 2:4])
  LSLW.local.gamma.500[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[3, 2:4])
  nonpara.local.gamma.500[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[4, 2:4])
  para.local.gamma.500[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[5, 2:4])
  transform.local.gamma.500[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[6, 2:4])
  
  # conditional coverages
  HD.inx.gamma.500[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[1, 5:29])
  LS.inx.gamma.500[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[2, 5:29])
  LSLW.inx.gamma.500[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[3, 5:29])
  nonpara.inx.gamma.500[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[4, 5:29])
  para.inx.gamma.500[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[5, 5:29])
  transform.inx.gamma.500[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[6, 5:29])

  # area
  HD.area.gamma.500[k] <- as.numeric(internal.output[1, 30])
  LS.area.gamma.500[k] <- as.numeric(internal.output[2, 30])
  LSLW.area.gamma.500[k] <- as.numeric(internal.output[3, 30])
  nonpara.area.gamma.500[k] <- as.numeric(internal.output[4, 30])
  para.area.gamma.500[k] <- as.numeric(internal.output[5, 30])
  transform.area.gamma.500[k] <- as.numeric(internal.output[6, 30])

  # prediction error
  HD.error.gamma.500[k] <- as.numeric(internal.output[1, 31])
  LS.error.gamma.500[k] <- as.numeric(internal.output[2, 31])
  LSLW.error.gamma.500[k] <- as.numeric(internal.output[3, 31])
  nonpara.error.gamma.500[k] <- as.numeric(internal.output[4, 31])
  para.error.gamma.500[k] <- as.numeric(internal.output[5, 31])
  transform.error.gamma.500[k] <- as.numeric(internal.output[6, 31])  
}
@
...
plot.new()
plot.window(xlim = c(log(min(shapes)), log(max(shapes))), ylim = c(0.40, 3))
lines(log(shapes), para.area.gamma.150, col = "red", lty = 1, lwd = 1.5)
lines(log(shapes), transform.area.gamma.150, col = "red", lty = 2, lwd = 1.5)
...
plot.window(xlim = c(log(min(shapes)), log(max(shapes))), 
  ylim = c(0, 0.60))
legend(-0.25, 0.55, legend=c("bin param", "transform param",
  "bin nonparam", "LSLW", "LS", 
  "HD", "nominal coverage"), col=c("red", "red", "green", "purple", 
...
lines(log(shapes), transform.error.gamma.150, col = "red", lty = 2, lwd = 1.5)
...
plot.window(xlim = c(log(min(shapes)), log(max(shapes))), 
  ylim = c(0.80, 1.00))
lines(log(shapes), para.marginal.gamma.150, col = "red", lty = 1, lwd = 1.5)
lines(log(shapes), transform.marginal.gamma.150, col = "red", lty = 2, lwd = 1.5)
lines(log(shapes), nonpara.marginal.gamma.150, col = "green", lty = 2, lwd = 1.5)
lines(log(shapes), LSLW.marginal.gamma.150, col = "purple", lty = 1, lwd = 1.5)
lines(log(shapes), LS.marginal.gamma.150, col = "black", lty = 2, lwd = 1.5)
lines(log(shapes), HD.marginal.gamma.150, col = "blue", lty = 4, lwd = 1.5)
abline(h = 0.90, lty = 1, col = "grey", lwd = 1)
axis(2)
mtext("marginal coverage", side = 2, cex = 1.25, line = 2)
...
lines(log(shapes), transform.local.gamma.150[2*(1:s) - 1], col = "red", lty = 2, lwd = 1.5)
...
abline(h = 0.90, lty = 1, col = "grey", lwd = 1)
axis(1); axis(2)
mtext("coverage when 0 < x <= 1/2", side = 2, cex = 1, line = 2)

plot.new()
plot.window(xlim = c(log(min(shapes)), log(max(shapes))), 
  ylim = c(0.70, 1.00))
lines(log(shapes), para.local.gamma.150[2*(1:s)], col = "red", lty = 1, lwd = 1.5)
lines(log(shapes), transform.local.gamma.150[2*(1:s)], col = "red", lty = 2, lwd = 1.5)
...
abline(h = 0.90, lty = 1, col = "grey", lwd = 1)
axis(1); axis(2)
mtext("coverage when 1/2 < x < 1", side = 2, cex = 1, line = 2)
...
lines(inx, transform.inx.gamma.150[26:50], col = "red", lty = 2, lwd = 1.5)
...
abline(h = 0.90, lty = 1, col = "grey", lwd = 2)
axis(2)
mtext("shape = 1", side = 3, cex = 1, line = 2)

plot.new()
plot.window(xlim = c(0,1), ylim = c(0.90, 0.98))
legend(-0.1, 0.98, legend=c("bin param", "transform", 
  "bin nonparam", "LSLW", "LS", 
  "HD", "nominal coverage"), col=c("red", "red", "green", "purple", 
  "black", "blue", "grey"), cex = 1,
  lty=c(1,2,2,1,2,4,1), bty = "n")
...
lines(inx, transform.inx.gamma.150[51:75], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.150[101:125], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.150[126:150], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.150[151:175], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.150[176:200], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.150[201:225], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.150[226:250], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.150[251:275], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.150[276:300], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.150[301:325], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.150[326:350], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.150[351:375], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.150[376:400], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.150[401:425], col = "red", lty = 2, lwd = 1.5)
...
par(mfrow = c(3,3), oma = c(4,4,3,0), mar = c(1,1,1,2))
shapes <- c(0.5, 0.75, 1, 1.5, 2, 5, 7, 10, 12, 15, 20, 25)

plot.new()
plot.window(xlim = c(log(min(shapes)), log(max(shapes))), ylim = c(0.40, 3))
lines(log(shapes), para.area.gamma.250, col = "red", lty = 1, lwd = 1.5)
lines(log(shapes), transform.area.gamma.250, col = "red", lty = 2, lwd = 1.5)
...
lines(log(shapes), transform.error.gamma.250, col = "red", lty = 2, lwd = 1.5)
...
plot.window(xlim = c(log(min(shapes)), log(max(shapes))), 
  ylim = c(0, 0.60))
legend(-0.40, 0.55, legend=c("bin param", "transform param",
  "bin nonparam", "LSLW", "LS", 
  "HD", "nominal coverage"), col=c("red", "red", "green", "purple", 
  "black", "blue", "grey"), cex = 1.25, 
  lty=c(1,2,2,1,2,4,1), bty = "n")
...
lines(log(shapes), transform.local.gamma.250[3*(1:s) - 2], col = "red", lty = 2, lwd = 1.5)
...
lines(log(shapes), transform.local.gamma.250[3*(1:s) - 1], col = "red", lty = 2, lwd = 1.5)
...
lines(log(shapes), transform.local.gamma.250[3*(1:s)], col = "red", lty = 2, lwd = 1.5)
...
plot.window(xlim = c(log(min(shapes)), log(max(shapes))), 
  ylim = c(0.80, 0.95))
lines(log(shapes), para.marginal.gamma.250, col = "red", lty = 1, lwd = 1.5)
lines(log(shapes), transform.marginal.gamma.250, col = "red", lty = 2, lwd = 1.5)
lines(log(shapes), nonpara.marginal.gamma.250, col = "green", lty = 2, lwd = 1.5)
lines(log(shapes), LSLW.marginal.gamma.250, col = "purple", lty = 1, lwd = 1.5)
lines(log(shapes), LS.marginal.gamma.250, col = "black", lty = 2, lwd = 1.5)
lines(log(shapes), HD.marginal.gamma.250, col = "blue", lty = 4, lwd = 1.5)
abline(h = 0.90, lty = 1, col = "grey", lwd = 2)
axis(1); axis(2)
mtext("marginal coverage", side = 2, cex = 1, line = 2)
...
lines(inx, transform.inx.gamma.250[1:25], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.250[26:50], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.250[51:75], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.250[76:100], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.250[101:125], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.250[126:150], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.250[151:175], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.250[176:200], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.250[201:225], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.250[226:250], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.250[251:275], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.250[276:300], col = "red", lty = 2, lwd = 1.5)
...
par(mfrow = c(3,3), oma = c(4,4,2,0), mar = c(1,1,1,2))
shapes <- c(0.5, 0.75, 1, 1.5, 2, 5, 7, 10, 12, 15, 20, 25)

plot.new()
plot.window(xlim = c(log(min(shapes)), log(max(shapes))), ylim = c(0.40, 3))
lines(log(shapes), para.area.gamma.500, col = "red", lty = 1, lwd = 1.5)
lines(log(shapes), transform.area.gamma.500, col = "red", lty = 2, lwd = 1.5)
...
lines(log(shapes), transform.error.gamma.500, col = "red", lty = 2, lwd = 1.5)
...
plot.window(xlim = c(log(min(shapes)), log(max(shapes))), 
  ylim = c(0, 0.60))
legend(-0.40, 0.60, legend=c("bin param", "transform param",
  "bin nonparam", "LSLW", "LS", 
  "HD", "nominal coverage"), col=c("red", "red", "green", "purple", 
  "black", "blue", "grey"), cex = 1.25, 
  lty=c(1,2,2,1,2,4,1), bty = "n")
...
lines(log(shapes), transform.local.gamma.500[3*(1:s) - 2], col = "red", lty = 2, lwd = 1.5)
...
lines(log(shapes), transform.local.gamma.500[3*(1:s) - 1], col = "red", lty = 2, lwd = 1.5)
...
lines(log(shapes), transform.local.gamma.500[3*(1:s)], col = "red", lty = 2, lwd = 1.5)
...
plot.window(xlim = c(log(min(shapes)), log(max(shapes))), 
  ylim = c(0.85, 0.93))
lines(log(shapes), para.marginal.gamma.500, col = "red", lty = 1, lwd = 1.5)
lines(log(shapes), transform.marginal.gamma.500, col = "red", lty = 2, lwd = 1.5)
lines(log(shapes), nonpara.marginal.gamma.500, col = "green", lty = 2, lwd = 1.5)
lines(log(shapes), LSLW.marginal.gamma.500, col = "purple", lty = 1, lwd = 1.5)
lines(log(shapes), LS.marginal.gamma.500, col = "black", lty = 2, lwd = 1.5)
lines(log(shapes), HD.marginal.gamma.500, col = "blue", lty = 4, lwd = 1.5)
abline(h = 0.90, lty = 1, col = "grey", lwd = 2)
axis(2)
mtext("marginal coverage", side = 2, cex = 1, line = 2)
axis(1)
...
lines(inx, transform.inx.gamma.500[1:25], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.500[26:50], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.500[51:75], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.500[76:100], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.500[101:125], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.500[126:150], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.500[151:175], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.500[176:200], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.500[201:225], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.500[226:250], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.500[251:275], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.gamma.500[276:300], col = "red", lty = 2, lwd = 1.5)
...
misspec_simulator <- function(beta, n = 150, shape = 0.5, 
  ...
  models <- lapply(1:B, FUN = function(j){
    ...
    fit.true <- glm(y ~ x1, family = "Gamma", 
      data = dat, x = TRUE, y = TRUE)        
  ...
  conformal_regions <- lapply(models, FUN = function(obj){
    ...
    HDCI <- do.call(rbind, lapply(1:n, function(j){ 
      hdi(qnorm, 1 - alpha, mean = meanMLE[j], sd = sdMLE)
    }))

    model.true <- obj$model.true
...
para.area.misspec.150 <- nonpara.area.misspec.150 <- 
  ...
  HD.area.misspec.150 <- trueHD.area.misspec.150 <- 
  transform.area.misspec.150 <- NULL
para.error.misspec.150 <- nonpara.error.misspec.150 <- 
  LS.error.misspec.150 <- LSLW.error.misspec.150 <- 
  HD.error.misspec.150 <- trueHD.error.misspec.150 <- 
  transform.error.misspec.150 <- NULL
para.marginal.misspec.150 <- nonpara.marginal.misspec.150 <- 
  LS.marginal.misspec.150 <- LSLW.marginal.misspec.150 <- 
  HD.marginal.misspec.150 <- trueHD.marginal.misspec.150 <- 
  transform.marginal.misspec.150 <- NULL
para.local.misspec.150 <- nonpara.local.misspec.150 <- 
  LS.local.misspec.150 <- LSLW.local.misspec.150 <- 
  HD.local.misspec.150 <- trueHD.local.misspec.150 <- 
  transform.local.misspec.150 <- NULL
para.inx.misspec.150 <- nonpara.inx.misspec.150 <- 
  LS.inx.misspec.150 <- LSLW.inx.misspec.150 <- 
  HD.inx.misspec.150 <- trueHD.inx.misspec.150 <- 
  transform.inx.misspec.150 <- NULL  
...
#  30, 40, 50, 60, 70, 80, 90, 100)
for(j in shapes ){
  internal.output <- eval(parse(text=paste("diagnostics.misspec.150.2", j, sep = ".")))
  k <- which(shapes == j)

  # marginal coverages
  HD.marginal.misspec.150[k] <- as.numeric(internal.output[1, 1])
  trueHD.marginal.misspec.150[k] <- as.numeric(internal.output[2, 1])  
  LS.marginal.misspec.150[k] <- as.numeric(internal.output[3, 1])
  LSLW.marginal.misspec.150[k] <- as.numeric(internal.output[4, 1])
  nonpara.marginal.misspec.150[k] <- as.numeric(internal.output[5, 1])
  para.marginal.misspec.150[k] <- as.numeric(internal.output[6, 1])
  transform.marginal.misspec.150[k] <- as.numeric(internal.output[7, 1])

  # local coverages
  HD.local.misspec.150[(2*k-1):(2*k)] <- as.numeric(internal.output[1, 2:3])
  trueHD.local.misspec.150[(2*k-1):(2*k)] <- as.numeric(internal.output[2, 2:3])  
  LS.local.misspec.150[(2*k-1):(2*k)] <- as.numeric(internal.output[3, 2:3])
  LSLW.local.misspec.150[(2*k-1):(2*k)] <- as.numeric(internal.output[4, 2:3])
  nonpara.local.misspec.150[(2*k-1):(2*k)] <- as.numeric(internal.output[5, 2:3])
  para.local.misspec.150[(2*k-1):(2*k)] <- as.numeric(internal.output[6, 2:3])
  transform.local.misspec.150[(2*k-1):(2*k)] <- as.numeric(internal.output[7, 2:3])

  # conditional coverages
  HD.inx.misspec.150[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[1, 4:28])
  trueHD.inx.misspec.150[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[2, 4:28])
  LS.inx.misspec.150[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[3, 4:28])
  LSLW.inx.misspec.150[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[4, 4:28])
  nonpara.inx.misspec.150[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[5, 4:28])
  para.inx.misspec.150[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[6, 4:28])
  transform.inx.misspec.150[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[7, 4:28])

  # area
  HD.area.misspec.150[k] <- as.numeric(internal.output[1, 29])
  trueHD.area.misspec.150[k] <- as.numeric(internal.output[2, 29])  
  LS.area.misspec.150[k] <- as.numeric(internal.output[3, 29])
  LSLW.area.misspec.150[k] <- as.numeric(internal.output[4, 29])
  nonpara.area.misspec.150[k] <- as.numeric(internal.output[5, 29])
  para.area.misspec.150[k] <- as.numeric(internal.output[6, 29])
  transform.area.misspec.150[k] <- as.numeric(internal.output[7, 29])

  # prediction error
  HD.error.misspec.150[k] <- as.numeric(internal.output[1, 30])
  trueHD.error.misspec.150[k] <- as.numeric(internal.output[2, 30])    
  LS.error.misspec.150[k] <- as.numeric(internal.output[3, 30])
  LSLW.error.misspec.150[k] <- as.numeric(internal.output[4, 30])
  nonpara.error.misspec.150[k] <- as.numeric(internal.output[5, 30])
  para.error.misspec.150[k] <- as.numeric(internal.output[6, 30])
  transform.error.misspec.150[k] <- as.numeric(internal.output[7, 30])
}
@
...
para.area.misspec.250 <- nonpara.area.misspec.250 <- 
  ...
  HD.area.misspec.250 <- trueHD.area.misspec.250 <- 
  transform.area.misspec.250 <- NULL
para.error.misspec.250 <- nonpara.error.misspec.250 <- 
  LS.error.misspec.250 <- LSLW.error.misspec.250 <- 
  HD.error.misspec.250 <- trueHD.error.misspec.250 <- 
  transform.error.misspec.250 <- NULL
para.marginal.misspec.250 <- nonpara.marginal.misspec.250 <- 
  LS.marginal.misspec.250 <- LSLW.marginal.misspec.250 <- 
  HD.marginal.misspec.250 <- trueHD.marginal.misspec.250 <- 
  transform.marginal.misspec.250 <- NULL
para.local.misspec.250 <- nonpara.local.misspec.250 <- 
  LS.local.misspec.250 <- LSLW.local.misspec.250 <- 
  HD.local.misspec.250 <- trueHD.local.misspec.250 <- 
  transform.local.misspec.250 <- NULL
para.inx.misspec.250 <- nonpara.inx.misspec.250 <- 
  LS.inx.misspec.250 <- LSLW.inx.misspec.250 <- 
  HD.inx.misspec.250 <- trueHD.inx.misspec.250 <- 
  transform.inx.misspec.250 <- NULL  

shapes <- c(5, 20, 40, 60, 80, 100)
for(j in shapes ){
  internal.output <- eval(parse(text=paste("diagnostics.misspec.250.3", j, sep = ".")))
  k <- which(shapes == j)

  # marginal coverages
  HD.marginal.misspec.250[k] <- as.numeric(internal.output[1, 1])
  trueHD.marginal.misspec.250[k] <- as.numeric(internal.output[2, 1])  
  LS.marginal.misspec.250[k] <- as.numeric(internal.output[3, 1])
  LSLW.marginal.misspec.250[k] <- as.numeric(internal.output[4, 1])
  nonpara.marginal.misspec.250[k] <- as.numeric(internal.output[5, 1])
  para.marginal.misspec.250[k] <- as.numeric(internal.output[6, 1])
  transform.marginal.misspec.250[k] <- as.numeric(internal.output[7, 1])

  # local coverages
  HD.local.misspec.250[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[1, 2:4])
  trueHD.local.misspec.250[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[2, 2:4])  
  LS.local.misspec.250[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[3, 2:4])
  LSLW.local.misspec.250[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[4, 2:4])
  nonpara.local.misspec.250[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[5, 2:4])
  para.local.misspec.250[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[6, 2:4])
  transform.local.misspec.250[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[7, 2:4])

  # conditional coverages
  HD.inx.misspec.250[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[1, 5:29])
  trueHD.inx.misspec.250[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[2, 5:29])  
  LS.inx.misspec.250[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[3, 5:29])
  LSLW.inx.misspec.250[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[4, 5:29])
  nonpara.inx.misspec.250[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[5, 5:29])
  para.inx.misspec.250[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[6, 5:29])
  transform.inx.misspec.250[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[7, 5:29])

  # area
  HD.area.misspec.250[k] <- as.numeric(internal.output[1, 30])
  trueHD.area.misspec.250[k] <- as.numeric(internal.output[2, 30])  
  LS.area.misspec.250[k] <- as.numeric(internal.output[3, 30])
  LSLW.area.misspec.250[k] <- as.numeric(internal.output[4, 30])
  nonpara.area.misspec.250[k] <- as.numeric(internal.output[5, 30])
  para.area.misspec.250[k] <- as.numeric(internal.output[6, 30])
  transform.area.misspec.250[k] <- as.numeric(internal.output[7, 30])

  # prediction error
  HD.error.misspec.250[k] <- as.numeric(internal.output[1, 31])
  trueHD.error.misspec.250[k] <- as.numeric(internal.output[2, 31]) 
  LS.error.misspec.250[k] <- as.numeric(internal.output[3, 31])
  LSLW.error.misspec.250[k] <- as.numeric(internal.output[4, 31])
  nonpara.error.misspec.250[k] <- as.numeric(internal.output[5, 31])
  para.error.misspec.250[k] <- as.numeric(internal.output[6, 31])
  transform.error.misspec.250[k] <- as.numeric(internal.output[7, 31])
}
@
...
para.area.misspec.500 <- nonpara.area.misspec.500 <- 
  ...
  HD.area.misspec.500 <- trueHD.area.misspec.500 <- 
  transform.area.misspec.500 <- NULL
para.error.misspec.500 <- nonpara.error.misspec.500 <- 
  LS.error.misspec.500 <- LSLW.error.misspec.500 <- 
  HD.error.misspec.500 <- trueHD.error.misspec.500 <- 
  transform.error.misspec.500 <- NULL
para.marginal.misspec.500 <- nonpara.marginal.misspec.500 <- 
  LS.marginal.misspec.500 <- LSLW.marginal.misspec.500 <- 
  HD.marginal.misspec.500 <- trueHD.marginal.misspec.500 <- 
  transform.marginal.misspec.500 <- NULL
para.local.misspec.500 <- nonpara.local.misspec.500 <- 
  LS.local.misspec.500 <- LSLW.local.misspec.500 <- 
  HD.local.misspec.500 <- trueHD.local.misspec.500 <- 
  transform.local.misspec.500 <- NULL
para.inx.misspec.500 <- nonpara.inx.misspec.500 <- 
  LS.inx.misspec.500 <- LSLW.inx.misspec.500 <- 
  HD.inx.misspec.500 <- trueHD.inx.misspec.500 <- 
  transform.inx.misspec.500 <- NULL  

shapes <- c(5, 20, 40, 60, 80, 100)
for(j in shapes ){
  internal.output <- eval(parse(text=paste("diagnostics.misspec.500.3", j, sep = ".")))
  k <- which(shapes == j)

  # marginal coverages
  HD.marginal.misspec.500[k] <- as.numeric(internal.output[1, 1])
  trueHD.marginal.misspec.500[k] <- as.numeric(internal.output[2, 1])
  LS.marginal.misspec.500[k] <- as.numeric(internal.output[3, 1])
  LSLW.marginal.misspec.500[k] <- as.numeric(internal.output[4, 1])
  nonpara.marginal.misspec.500[k] <- as.numeric(internal.output[5, 1])
  para.marginal.misspec.500[k] <- as.numeric(internal.output[6, 1])
  transform.marginal.misspec.500[k] <- as.numeric(internal.output[7, 1])

  # local coverages
  HD.local.misspec.500[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[1, 2:4])
  trueHD.local.misspec.500[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[2, 2:4])
  LS.local.misspec.500[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[3, 2:4])
  LSLW.local.misspec.500[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[4, 2:4])
  nonpara.local.misspec.500[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[5, 2:4])
  para.local.misspec.500[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[6, 2:4])
  transform.local.misspec.500[(3*(k-1)+1):(3*k)] <- as.numeric(internal.output[7, 2:4])

  # conditional coverages
  HD.inx.misspec.500[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[1, 5:29])
  trueHD.inx.misspec.500[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[2, 5:29])  
  LS.inx.misspec.500[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[3, 5:29])
  LSLW.inx.misspec.500[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[4, 5:29])
  nonpara.inx.misspec.500[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[5, 5:29])
  para.inx.misspec.500[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[6, 5:29])
  transform.inx.misspec.500[((25*(k-1)+1)):(25*k)] <- as.numeric(internal.output[7, 5:29])

  # area
  HD.area.misspec.500[k] <- as.numeric(internal.output[1, 30])
  trueHD.area.misspec.500[k] <- as.numeric(internal.output[2, 30])
  LS.area.misspec.500[k] <- as.numeric(internal.output[3, 30])
  LSLW.area.misspec.500[k] <- as.numeric(internal.output[4, 30])
  nonpara.area.misspec.500[k] <- as.numeric(internal.output[5, 30])
  para.area.misspec.500[k] <- as.numeric(internal.output[6, 30])
  transform.area.misspec.500[k] <- as.numeric(internal.output[7, 30])

  # prediction error
  HD.error.misspec.500[k] <- as.numeric(internal.output[1, 31])
  trueHD.error.misspec.500[k] <- as.numeric(internal.output[2, 31])  
  LS.error.misspec.500[k] <- as.numeric(internal.output[3, 31])
  LSLW.error.misspec.500[k] <- as.numeric(internal.output[4, 31])
  nonpara.error.misspec.500[k] <- as.numeric(internal.output[5, 31])
  para.error.misspec.500[k] <- as.numeric(internal.output[6, 31])
  transform.error.misspec.500[k] <- as.numeric(internal.output[6, 31])
}
@
...
plot.new()
plot.window(xlim = c(log(min(shapes)), log(max(shapes))), ylim = c(0.90, 3.50))
lines(log(shapes), para.area.misspec.150, col = "red", lty = 1, lwd = 1.5)
lines(log(shapes), transform.area.misspec.150, col = "red", lty = 2, lwd = 1.5)
...
plot.window(xlim = c(log(min(shapes)), log(max(shapes))), 
  ylim = c(0, 0.60))
legend(0, 0.55, legend=c("miss bin param", "miss transform param", 
  "nonparam", "LSLW", "LS", "miss HD", "true HD", 
  "nominal coverage"), 
  col=c("red", "red", "green", "purple", "black", "blue", "orange", "grey"), 
  cex = 1.25, lty=c(1,2,2,1,2,4,1,1), bty = "n")

plot.new()
plot.window(xlim = c(log(min(shapes)), log(max(shapes))), 
  ylim = c(0, 0.25))
lines(log(shapes), para.error.misspec.150, col = "red", lty = 1, lwd = 1.5)
lines(log(shapes), transform.error.misspec.150, col = "red", lty = 2, lwd = 1.5)
...
plot.window(xlim = c(log(min(shapes)), log(max(shapes))), 
  ylim = c(0.85, 0.95))
lines(log(shapes), para.marginal.misspec.150, col = "red", lty = 1, lwd = 1.5)
lines(log(shapes), transform.marginal.misspec.150, col = "red", lty = 2, lwd = 1.5)
lines(log(shapes), nonpara.marginal.misspec.150, col = "green", lty = 2, lwd = 1.5)
lines(log(shapes), LSLW.marginal.misspec.150, col = "purple", lty = 1, lwd = 1.5)
lines(log(shapes), LS.marginal.misspec.150, col = "black", lty = 2, lwd = 1.5)
lines(log(shapes), HD.marginal.misspec.150, col = "blue", lty = 4, lwd = 1.5)
lines(log(shapes), trueHD.marginal.misspec.150, col = "orange", lty = 1, lwd = 1.5)
abline(h = 0.90, lty = 1, col = "grey", lwd = 2)
axis(2)
mtext("marginal coverage", side = 2, cex = 1.25, line = 2)
...
lines(log(shapes), transform.local.misspec.150[2*(1:s) - 1], col = "red", lty = 2, lwd = 1.5)
...
lines(log(shapes), transform.local.misspec.150[2*(1:s)], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.misspec.150[1:25], col = "red", lty = 2, lwd = 1.5)
...
plot.window(xlim = c(log(min(shapes)), log(max(shapes))), 
  ylim = c(0, 0.60))
legend(-0.25, 0.60, legend=c("miss bin param", "miss transform", 
  " bin nonparam", "LSLW", "LS", "miss HD", "true HD", 
  "nominal coverage"), 
  col=c("red", "red", "green", "purple", "black", "blue", "orange", "grey"), cex = 0.90,
  lty=c(1,2,2,1,2,4,1,1), bty = "n")

# shape = 1
plot.new()
plot.window(xlim = c(0, 1), ylim = c(0.25, 1.00))
lines(inx, para.inx.misspec.150[26:50], col = "red", lty = 1, lwd = 1.5)
lines(inx, transform.inx.misspec.150[26:50], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.misspec.150[51:75], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.misspec.150[76:100], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.misspec.150[101:125], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.misspec.150[126:150], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.misspec.150[151:175], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.misspec.150[176:200], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.misspec.150[201:225], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.misspec.150[226:250], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.misspec.150[251:275], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.misspec.150[276:300], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.misspec.150[301:325], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.misspec.150[326:350], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.misspec.150[351:375], col = "red", lty = 2, lwd = 1.5)
...
plot.new()
plot.window(xlim = c(log(min(shapes)), log(max(shapes))), ylim = c(0.50, 3.00))
lines(log(shapes), para.area.misspec.250, col = "red", lty = 1, lwd = 1.5)
lines(log(shapes), transform.area.misspec.250, col = "red", lty = 2, lwd = 1.5)
lines(log(shapes), transform.area.misspec.250, col = "red", lty = 2, lwd = 1.5)
...
lines(log(shapes), trueHD.area.misspec.250, col = "blue", lty = 4, lwd = 1.5)
axis(2)
mtext("area", side = 2, cex = 1, line = 2)
...
lines(log(shapes), transform.error.misspec.250, col = "red", lty = 2, lwd = 1.5)
...
lines(log(shapes), trueHD.error.misspec.250, col = "blue", lty = 4, lwd = 1.5)
axis(2)
mtext("prediction error", side = 2, cex = 1, line = 2)

plot.new()
plot.window(xlim = c(0, 1), ylim = c(0, 0.60))
legend(0, 0.60, legend=c("miss bin param", "miss transform",  
  "miss bin nonparam", "LSLW", "LS", "true HD", "nominal coverage"), 
  col=c("red", "red", "green", "purple", "black", "blue", "grey"), 
  cex = 1.25, lty=c(1,2,2,1,2,4,1), bty = "n")
...
lines(log(shapes), transform.local.misspec.250[3*(1:s) - 2], col = "red", lty = 2, lwd = 1.5)
...
lines(log(shapes), trueHD.local.misspec.250[3*(1:s) - 2], col = "blue", lty = 4, lwd = 1.5)
abline(h = 0.90, lty = 1, col = "grey", lwd = 2)
axis(2)
mtext("coverage when 0 < x < 1/3", side = 2, cex = 1, line = 2)
...
lines(log(shapes), transform.local.misspec.250[3*(1:s) - 1], col = "red", lty = 2, lwd = 1.5)
...
lines(log(shapes), trueHD.local.misspec.250[3*(1:s) - 1], col = "blue", lty = 4, lwd = 1.5)
abline(h = 0.90, lty = 1, col = "grey", lwd = 2)
axis(1); axis(2)
mtext("coverage when 1/3 <= x < 2/3", side = 2, cex = 1, line = 2)
...
lines(log(shapes), transform.local.misspec.250[3*(1:s)], col = "red", lty = 2, lwd = 1.5)
...
lines(log(shapes), trueHD.local.misspec.250[3*(1:s)], col = "blue", lty = 4, lwd = 1.5)
abline(h = 0.90, lty = 1, col = "grey", lwd = 2)
axis(1); axis(2)
mtext("coverage when 2/3 <= x < 1", side = 2, cex = 1, line = 2)
...
plot.window(xlim = c(log(min(shapes)), log(max(shapes))), 
  ylim = c(0.78, 0.95))
lines(log(shapes), para.marginal.misspec.250, col = "red", lty = 1, lwd = 1.5)
lines(log(shapes), transform.marginal.misspec.250, col = "red", lty = 2, lwd = 1.5)
lines(log(shapes), nonpara.marginal.misspec.250, col = "green", lty = 2, lwd = 1.5)
lines(log(shapes), LSLW.marginal.misspec.250, col = "purple", lty = 1, lwd = 1.5)
lines(log(shapes), LS.marginal.misspec.250, col = "black", lty = 2, lwd = 1.5)
lines(log(shapes), trueHD.marginal.misspec.250, col = "blue", lty = 4, lwd = 1.5)
abline(h = 0.90, lty = 1, col = "grey", lwd = 2)
axis(1); axis(2)
mtext("marginal coverage", side = 2, cex = 1, line = 2)
...
lines(inx, transform.inx.misspec.250[1:25], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, trueHD.inx.misspec.250[1:25], col = "blue", lty = 4, lwd = 1.5)
abline(h = 0.90, lty = 1, col = "grey", lwd = 2)
axis(2)
mtext("shape = 5", side = 3, cex = 1, line = 2)
...
plot.new()
plot.window(xlim = c(0, 1), ylim = c(0.90, 0.98))
legend(0, 0.98, legend=c("miss bin param", "miss transform", 
  "bin nonparam", "LSLW", "LS", "true HD", "nominal coverage"), 
  col=c("red", "red", "green", "purple", "black", "blue", "grey"), 
  cex = 1, 
  lty=c(1,2,2,1,2,4,1), bty = "n")
...
lines(inx, transform.inx.misspec.250[26:50], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, trueHD.inx.misspec.250[26:50], col = "blue", lty = 4, lwd = 1.5)
abline(h = 0.90, lty = 1, col = "grey", lwd = 2)
axis(2)
mtext("shape = 20", side = 3, cex = 1, line = 2)
...
lines(inx, transform.inx.misspec.250[51:75], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, trueHD.inx.misspec.250[51:75], col = "blue", lty = 4, lwd = 1.5)
abline(h = 0.90, lty = 1, col = "grey", lwd = 2)
mtext("shape = 40", side = 3, cex = 1, line = 2)
...
lines(inx, transform.inx.misspec.250[76:100], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, trueHD.inx.misspec.250[76:100], col = "blue", lty = 4, lwd = 1.5)
abline(h = 0.90, lty = 1, col = "grey", lwd = 2)
axis(2)
mtext("shape = 60", side = 3, cex = 1, line = 2)
...
lines(inx, transform.inx.misspec.250[101:125], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, trueHD.inx.misspec.250[101:125], col = "blue", lty = 4, lwd = 1.5)
abline(h = 0.90, lty = 1, col = "grey", lwd = 2)
axis(1)
mtext("shape = 80", side = 3, cex = 1, line = 2)
...
lines(inx, transform.inx.misspec.250[126:150], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, trueHD.inx.misspec.250[126:150], col = "blue", lty = 4, lwd = 1.5)
abline(h = 0.90, lty = 1, col = "grey", lwd = 2)
axis(1); axis(2)
...
lines(log(shapes), transform.area.misspec.500, col = "red", lty = 2, lwd = 1.5)
...
lines(log(shapes), transform.error.misspec.500, col = "red", lty = 2, lwd = 1.5)
...
lines(log(shapes), transform.local.misspec.500[3*(1:s) - 2], col = "red", lty = 2, lwd = 1.5)
...
lines(log(shapes), transform.local.misspec.500[3*(1:s) - 1], col = "red", lty = 2, lwd = 1.5)
...
lines(log(shapes), transform.local.misspec.500[3*(1:s)], col = "red", lty = 2, lwd = 1.5)
...
plot.window(xlim = c(log(min(shapes)), log(max(shapes))), 
   ylim = c(0.80, 0.95))
lines(log(shapes), para.marginal.misspec.500, col = "red", lty = 1, lwd = 1.5)
lines(log(shapes), transform.marginal.misspec.500, col = "red", lty = 2, lwd = 1.5)
lines(log(shapes), nonpara.marginal.misspec.500, col = "green", lty = 2, lwd = 1.5)
lines(log(shapes), LSLW.marginal.misspec.500, col = "purple", lty = 1, lwd = 1.5)
lines(log(shapes), LS.marginal.misspec.500, col = "black", lty = 2, lwd = 1.5)
lines(log(shapes), HD.marginal.misspec.500, col = "blue", lty = 4, lwd = 1.5)
abline(h = 0.90, lty = 1, col = "grey", lwd = 2)
axis(1); axis(2)
mtext("marginal coverage", side = 2, cex = 1, line = 2)
...
lines(inx, transform.inx.misspec.500[1:25], col = "red", lty = 2, lwd = 1.5)
...
legend(0, 0.60, legend=c("miss bin param", "miss transform", 
  "bin nonparam", "LSLW", "LS", "true HD", "nominal coverage"), 
  col=c("red", "red", "green", "purple", "black", "blue", "grey"), 
  cex = 1, lty=c(1,2,2,1,2,4,1), bty = "n")

plot.new()
plot.window(xlim = c(0, 1), ylim = c(0.25, 1.00))
lines(inx, para.inx.misspec.500[26:50], col = "red", lty = 1, lwd = 1.5)
lines(inx, transform.inx.misspec.500[26:50], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.misspec.500[51:75], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.misspec.500[76:100], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.misspec.500[101:125], col = "red", lty = 2, lwd = 1.5)
...
lines(inx, transform.inx.misspec.500[126:150], col = "red", lty = 2, lwd = 1.5)
...
<<>>=
regression_simulator <- function(beta, n = 150, sd = 1, 
  alpha = 0.10, B = 2, bins = bins){
...
B <- 50
set.seed(13)
system.time(out.regression.150 <- do.call(rbind, 
  regression_simulator(beta = beta, n = n, bins = bins, B = B)))
diagnostics.regression.150 <- do.call(rbind, lapply(split(out.regression.150, 
  f = as.factor(rownames(out.regression.150))), 
  FUN = function(xx) colMeans(matrix(xx, nrow = B), na.rm = TRUE)))
@
...
B <- 50
set.seed(13)
system.time(out.regression.250 <- do.call(rbind, 
  regression_simulator(beta = beta, n = n, bins = bins, B = B)))
diagnostics.regression.250 <- do.call(rbind, lapply(split(out.regression.250, 
  f = as.factor(rownames(out.regression.150))), 
  FUN = function(xx) colMeans(matrix(xx, nrow = B), na.rm = TRUE)))
@
...
B <- 50
set.seed(13)
system.time(out.regression.500 <- do.call(rbind, 
  regression_simulator(beta = beta, n = n, bins = bins, B = B)))
diagnostics.regression.500 <- do.call(rbind, lapply(split(out.regression.500, 
  f = as.factor(rownames(out.regression.150))), 
  FUN = function(xx) colMeans(matrix(xx, nrow = B), na.rm = TRUE)))
@
...
<<echo = FALSE>>=
diagnostics.regression.150 <- round(diagnostics.regression.150, 3)
diagnostics.regression.250 <- round(diagnostics.regression.250, 3)
diagnostics.regression.500 <- round(diagnostics.regression.500, 3)
@
...
\begin{tabular}{llcccccc}
  ...
  $n = 150$
    & marginal coverage &
  $\Sexpr{diagnostics.regression.150[6, 1]}$ & 
  $\Sexpr{diagnostics.regression.150[5, 1]}$ & 
  $\Sexpr{diagnostics.regression.150[4, 1]}$ & 
  $\Sexpr{diagnostics.regression.150[2, 1]}$ & 
  $\Sexpr{diagnostics.regression.150[3, 1]}$ & 
  $\Sexpr{diagnostics.regression.150[1, 1]}$ \\
    & local coverage when $0 < x < 1/2$ & 
  $\Sexpr{diagnostics.regression.150[6, 2]}$ & 
  $\Sexpr{diagnostics.regression.150[5, 2]}$ & 
  $\Sexpr{diagnostics.regression.150[4, 2]}$ & 
  $\Sexpr{diagnostics.regression.150[2, 2]}$ & 
  $\Sexpr{diagnostics.regression.150[3, 2]}$ & 
  $\Sexpr{diagnostics.regression.150[1, 2]}$ \\
    & local coverage when $1/2 \leq x < 1$ & 
  $\Sexpr{diagnostics.regression.150[6, 3]}$ & 
  $\Sexpr{diagnostics.regression.150[5, 3]}$ & 
  $\Sexpr{diagnostics.regression.150[4, 3]}$ & 
  $\Sexpr{diagnostics.regression.150[2, 3]}$ & 
  $\Sexpr{diagnostics.regression.150[3, 3]}$ & 
  $\Sexpr{diagnostics.regression.150[1, 3]}$ \\
    & area &
  $\Sexpr{diagnostics.regression.150[6, 29]}$ & 
  $\Sexpr{diagnostics.regression.150[5, 29]}$ & 
  $\Sexpr{diagnostics.regression.150[4, 29]}$ & 
  $\Sexpr{diagnostics.regression.150[2, 29]}$ & 
  $\Sexpr{diagnostics.regression.150[3, 29]}$ & 
  $\Sexpr{diagnostics.regression.150[1, 29]}$ \\
    & prediction error &
  $\Sexpr{diagnostics.regression.150[6, 30]}$ & 
  $\Sexpr{diagnostics.regression.150[5, 30]}$ & 
  $\Sexpr{diagnostics.regression.150[4, 30]}$ & 
  $\Sexpr{diagnostics.regression.150[2, 30]}$ & 
  $\Sexpr{diagnostics.regression.150[3, 30]}$ & 
  $\Sexpr{diagnostics.regression.150[1, 30]}$ \\
  \hline
  $n = 250$  
    & marginal coverage &
  $\Sexpr{diagnostics.regression.250[6, 1]}$ & 
  $\Sexpr{diagnostics.regression.250[5, 1]}$ & 
  $\Sexpr{diagnostics.regression.250[4, 1]}$ & 
  $\Sexpr{diagnostics.regression.250[2, 1]}$ & 
  $\Sexpr{diagnostics.regression.250[3, 1]}$ & 
  $\Sexpr{diagnostics.regression.250[1, 1]}$ \\
    & local coverage when $0 < x < 1/3$ & 
  $\Sexpr{diagnostics.regression.250[6, 2]}$ & 
  $\Sexpr{diagnostics.regression.250[5, 2]}$ & 
  $\Sexpr{diagnostics.regression.250[4, 2]}$ & 
  $\Sexpr{diagnostics.regression.250[2, 2]}$ & 
  $\Sexpr{diagnostics.regression.250[3, 2]}$ & 
  $\Sexpr{diagnostics.regression.250[1, 2]}$ \\
    & local coverage when $1/3 \leq x < 2/3$ & 
  $\Sexpr{diagnostics.regression.250[6, 3]}$ & 
  $\Sexpr{diagnostics.regression.250[5, 3]}$ & 
  $\Sexpr{diagnostics.regression.250[4, 3]}$ & 
  $\Sexpr{diagnostics.regression.250[2, 3]}$ & 
  $\Sexpr{diagnostics.regression.250[3, 3]}$ & 
  $\Sexpr{diagnostics.regression.250[1, 3]}$ \\
    & local coverage when $2/3 \leq x < 1$ &
  $\Sexpr{diagnostics.regression.250[6, 4]}$ & 
  $\Sexpr{diagnostics.regression.250[5, 4]}$ & 
  $\Sexpr{diagnostics.regression.250[4, 4]}$ & 
  $\Sexpr{diagnostics.regression.250[2, 4]}$ & 
  $\Sexpr{diagnostics.regression.250[3, 4]}$ & 
  $\Sexpr{diagnostics.regression.250[1, 4]}$ \\
    & area & 
  $\Sexpr{diagnostics.regression.250[6, 30]}$ & 
  $\Sexpr{diagnostics.regression.250[5, 30]}$ & 
  $\Sexpr{diagnostics.regression.250[4, 30]}$ & 
  $\Sexpr{diagnostics.regression.250[2, 30]}$ & 
  $\Sexpr{diagnostics.regression.250[3, 30]}$ & 
  $\Sexpr{diagnostics.regression.250[1, 30]}$ \\
    & prediction error & 
  $\Sexpr{diagnostics.regression.250[6, 31]}$ & 
  $\Sexpr{diagnostics.regression.250[5, 31]}$ & 
  $\Sexpr{diagnostics.regression.250[4, 31]}$ & 
  $\Sexpr{diagnostics.regression.250[2, 31]}$ & 
  $\Sexpr{diagnostics.regression.250[3, 31]}$ & 
  $\Sexpr{diagnostics.regression.250[1, 31]}$ \\
  \hline
  $n = 500$
    & marginal coverage &
  $\Sexpr{diagnostics.regression.500[6, 1]}$ & 
  $\Sexpr{diagnostics.regression.500[5, 1]}$ & 
  $\Sexpr{diagnostics.regression.500[4, 1]}$ & 
  $\Sexpr{diagnostics.regression.500[2, 1]}$ & 
  $\Sexpr{diagnostics.regression.500[3, 1]}$ & 
  $\Sexpr{diagnostics.regression.500[1, 1]}$ \\
    & local coverage when $0 < x < 1/3$ & 
  $\Sexpr{diagnostics.regression.500[6, 2]}$ & 
  $\Sexpr{diagnostics.regression.500[5, 2]}$ & 
  $\Sexpr{diagnostics.regression.500[4, 2]}$ & 
  $\Sexpr{diagnostics.regression.500[2, 2]}$ & 
  $\Sexpr{diagnostics.regression.500[3, 2]}$ & 
  $\Sexpr{diagnostics.regression.500[1, 2]}$ \\
    & local coverage when $1/3 \leq x < 2/3$ & 
  $\Sexpr{diagnostics.regression.500[6, 3]}$ & 
  $\Sexpr{diagnostics.regression.500[5, 3]}$ & 
  $\Sexpr{diagnostics.regression.500[4, 3]}$ & 
  $\Sexpr{diagnostics.regression.500[2, 3]}$ & 
  $\Sexpr{diagnostics.regression.500[3, 3]}$ & 
  $\Sexpr{diagnostics.regression.500[1, 3]}$ \\
    & local coverage when $2/3 \leq x < 1$ &
  $\Sexpr{diagnostics.regression.500[6, 4]}$ & 
  $\Sexpr{diagnostics.regression.500[5, 4]}$ & 
  $\Sexpr{diagnostics.regression.500[4, 4]}$ & 
  $\Sexpr{diagnostics.regression.500[2, 4]}$ & 
  $\Sexpr{diagnostics.regression.500[3, 4]}$ & 
  $\Sexpr{diagnostics.regression.500[1, 4]}$ \\
    & area & 
  $\Sexpr{diagnostics.regression.500[6, 30]}$ & 
  $\Sexpr{diagnostics.regression.500[5, 30]}$ & 
  $\Sexpr{diagnostics.regression.500[4, 30]}$ & 
  $\Sexpr{diagnostics.regression.500[2, 30]}$ & 
  $\Sexpr{diagnostics.regression.500[3, 30]}$ & 
  $\Sexpr{diagnostics.regression.500[1, 30]}$ \\
    & prediction error & 
  $\Sexpr{diagnostics.regression.500[6, 31]}$ & 
  $\Sexpr{diagnostics.regression.500[5, 31]}$ & 
  $\Sexpr{diagnostics.regression.500[4, 31]}$ & 
  $\Sexpr{diagnostics.regression.500[2, 31]}$ & 
  $\Sexpr{diagnostics.regression.500[3, 31]}$ & 
  $\Sexpr{diagnostics.regression.500[1, 31]}$ 
\end{tabular}
\end{center}
...
lines(inx, diagnostics.regression.150[5, 4:28], col = "red", lty = 1, lwd = 1.5)
lines(inx, diagnostics.regression.150[6, 4:28], col = "red", lty = 2, lwd = 1.5)
lines(inx, diagnostics.regression.150[4, 4:28], col = "green", lty = 2, lwd = 1.5)
lines(inx, diagnostics.regression.150[3, 4:28], col = "purple", lty = 1, lwd = 1.5)
lines(inx, diagnostics.regression.150[2, 4:28], col = "black", lty = 2, lwd = 1.5)
lines(inx, diagnostics.regression.150[1, 4:28], col = "blue", lty = 4, lwd = 1.5)
...
plot.new()
plot.window(xlim = c(0, 1), ylim = c(0.60, 1.00))
lines(inx, diagnostics.regression.250[5, 5:29], col = "red", lty = 1, lwd = 1.5)
lines(inx, diagnostics.regression.250[6, 5:29], col = "red", lty = 2, lwd = 1.5)
lines(inx, diagnostics.regression.250[4, 5:29], col = "green", lty = 2, lwd = 1.5)
lines(inx, diagnostics.regression.250[3, 5:29], col = "purple", lty = 1, lwd = 1.5)
lines(inx, diagnostics.regression.250[2, 5:29], col = "black", lty = 2, lwd = 1.5)
lines(inx, diagnostics.regression.250[1, 5:29], col = "blue", lty = 4, lwd = 1.5)
abline(h = 0.90, lty = 1, col = "grey", lwd = 1.5)
axis(1)
...
#plot.new()
#plot.window(xlim = c(0, 1), ylim = c(0.60, 1.00))
legend(0.15, 0.85, legend=c("bin param", "trans param",  
  "bin nonparam", "LSLW", "LS", "HD", "nominal coverage"), 
  col=c("red", "red", "green", "purple", "black", "blue", "grey"), cex = 1,
  lty=c(1,2,2,1,2,4,1), bty = "n")

plot.new()
plot.window(xlim = c(0, 1), ylim = c(0.60, 1.00))
lines(inx, diagnostics.regression.500[5, 5:29], col = "red", lty = 1, lwd = 1.5)
lines(inx, diagnostics.regression.500[6, 5:29], col = "red", lty = 2, lwd = 1.5)
lines(inx, diagnostics.regression.500[4, 5:29], col = "green", lty = 2, lwd = 1.5)
lines(inx, diagnostics.regression.500[3, 5:29], col = "purple", lty = 1, lwd = 1.5)
lines(inx, diagnostics.regression.500[2, 5:29], col = "black", lty = 2, lwd = 1.5)
lines(inx, diagnostics.regression.500[1, 5:29], col = "blue", lty = 4, lwd = 1.5)
abline(h = 0.90, lty = 1, col = "grey", lwd = 1.5)
axis(1)
...
cpred <- conformal.glm(fit, nonparametric = TRUE, 
  alpha = alpha, method = "both",
  bins = bins, cores = cores)
paraCI <- cpred$paraconfbin
nonparaCI <- cpred$nonparaconfbin
transformCI <- cpred$transformconf
...
points(x, y, pch = 19, col = rgb(0,0,0,alpha=0.2))
lines(x[ix], transformCI[ix, 1], col = "red", lwd = 1.5)
lines(x[ix], transformCI[ix, 2], col = "red", lwd = 1.5)
axis(2)
mtext("Transform param \n conformal", side = 3, cex = 1, line = 0)
