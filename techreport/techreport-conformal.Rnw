...
for(j in shapes ){
  ...
  # local coverages
  HD.local.gamma.250[(3*(k-1)):(3*k)] <- as.numeric(internal.output[1, 2:4])
  LS.local.gamma.250[(3*(k-1)):(3*k)] <- as.numeric(internal.output[2, 2:4])
  LSLW.local.gamma.250[(3*(k-1)):(3*k)] <- as.numeric(internal.output[3, 2:4])
  nonpara.local.gamma.250[(3*(k-1)):(3*k)] <- as.numeric(internal.output[4, 2:4])
  para.local.gamma.250[(3*(k-1)):(3*k)] <- as.numeric(internal.output[5, 2:4])
  transform.local.gamma.250[(3*(k-1)):(3*k)] <- as.numeric(internal.output[6, 2:4])
...
for(j in shapes ){
  ...
  # local coverages
  HD.local.gamma.500[(3*(k-1)):(3*k)] <- as.numeric(internal.output[1, 2:4])
  LS.local.gamma.500[(3*(k-1)):(3*k)] <- as.numeric(internal.output[2, 2:4])
  LSLW.local.gamma.500[(3*(k-1)):(3*k)] <- as.numeric(internal.output[3, 2:4])
  nonpara.local.gamma.500[(3*(k-1)):(3*k)] <- as.numeric(internal.output[4, 2:4])
  para.local.gamma.500[(3*(k-1)):(3*k)] <- as.numeric(internal.output[5, 2:4])
  transform.local.gamma.500[(3*(k-1)):(3*k)] <- as.numeric(internal.output[6, 2:4])
...
legend(-0.25, 0.55, legend=c("bin param", "transform",
...
plot.new()
plot.window(xlim = c(0, 1), ylim = c(0.90, 0.98))
legend(0, 0.96, legend=c("bin param", 
  "bin nonparam", "LSLW", "LS", 
  "HD", "nominal coverage"), col=c("red", "red", "green", "purple", 
...
plot.new()
plot.window(xlim = c(0, 1), ylim = c(0.90, 0.98))
legend(0, 0.96, legend=c("bin param", "transform",  
  "bin nonparam", "LSLW", "LS", 
  "HD", "nominal coverage"), col=c("red", "red", "green", "purple", 
  "black", "blue", "grey"), cex = 1.5, 
  lty=c(1,2,2,1,2,4,1), bty = "n")
