...
\hlstd{gamma_simulator} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{beta}\hlstd{,} \hlkwc{n} \hlstd{=} \hlnum{150}\hlstd{,} \hlkwc{shape} \hlstd{=} \hlnum{0.5}\hlstd{,} \hlkwc{alpha} \hlstd{=} \hlnum{0.10}\hlstd{,} \hlkwc{B} \hlstd{=} \hlnum{2}\hlstd{)\{}
  ...
  \hlstd{conformal_regions} \hlkwb{<-} \hlkwd{lapply}\hlstd{(models,} \hlkwc{FUN} \hlstd{=} \hlkwa{function}\hlstd{(}\hlkwc{obj}\hlstd{)\{}
    \hlstd{x} \hlkwb{<-} \hlstd{obj}\hlopt{$}\hlstd{x[,} \hlopt{-}\hlnum{1}\hlstd{]}
    \hlstd{y} \hlkwb{<-} \hlstd{obj}\hlopt{$}\hlstd{y}
    \hlstd{p1.tibs} \hlkwb{<-} \hlkwd{conformal.pred}\hlstd{(}\hlkwc{x} \hlstd{=} \hlkwd{cbind}\hlstd{(x,x}\hlopt{^}\hlnum{2}\hlstd{,x}\hlopt{^}\hlnum{3}\hlstd{),} \hlkwc{y} \hlstd{= y,}
      \hlkwc{x0} \hlstd{=} \hlkwd{cbind}\hlstd{(x,x}\hlopt{^}\hlnum{2}\hlstd{,x}\hlopt{^}\hlnum{3}\hlstd{),}
      \hlkwc{train.fun} \hlstd{= train.fun,} \hlkwc{predict.fun} \hlstd{= predict.fun,}
      \hlkwc{alpha} \hlstd{= alpha)}
    ...
    \hlstd{betaMLE} \hlkwb{<-} \hlkwd{coefficients}\hlstd{(obj)}
    \hlstd{shapeMLE} \hlkwb{<-} \hlkwd{as.numeric}\hlstd{(}\hlkwd{gamma.shape}\hlstd{(obj)[}\hlnum{1}\hlstd{])}
    \hlstd{rateMLE} \hlkwb{<-} \hlkwd{cbind}\hlstd{(}\hlnum{1}\hlstd{, x)} \hlopt{%*%} \hlstd{betaMLE} \hlopt{*} \hlstd{shapeMLE}
    \hlstd{HDCI} \hlkwb{<-} \hlkwd{do.call}\hlstd{(rbind,} \hlkwd{lapply}\hlstd{(}\hlnum{1}\hlopt{:}\hlstd{n,} \hlkwa{function}\hlstd{(}\hlkwc{j}\hlstd{)\{}
      \hlkwd{hdi}\hlstd{(qgamma,} \hlnum{1} \hlopt{-} \hlstd{alpha,} \hlkwc{shape} \hlstd{= shapeMLE,} \hlkwc{rate} \hlstd{= rateMLE[j,} \hlnum{1}\hlstd{])}
    \hlstd{\}))}

    \hlstd{conf} \hlkwb{<-} \hlkwd{conformal.glm}\hlstd{(obj,} \hlkwc{nonparametric} \hlstd{=} \hlnum{TRUE}\hlstd{,} \hlkwc{method} \hlstd{=} \hlstr{"both"}\hlstd{,}
      \hlkwc{cores} \hlstd{=} \hlnum{7}\hlstd{)}
  ...
  \hlstd{diagnostics_regions} \hlkwb{<-} \hlkwd{lapply}\hlstd{(}\hlnum{1}\hlopt{:}\hlstd{B,} \hlkwc{FUN} \hlstd{=} \hlkwa{function}\hlstd{(}\hlkwc{j}\hlstd{)\{}
    ...
    \hlstd{dat} \hlkwb{<-} \hlstd{models[[j]]}\hlopt{$}\hlstd{data}
    \hlstd{foo} \hlkwb{<-} \hlkwd{lapply}\hlstd{(obj,} \hlkwc{FUN} \hlstd{=} \hlkwa{function}\hlstd{(}\hlkwc{region}\hlstd{)\{}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in xy.coords(x, y): object 'para.area.gamma.150' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in xy.coords(x, y): object 'nonpara.area.gamma.150' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in xy.coords(x, y): object 'LSLW.area.gamma.150' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in xy.coords(x, y): object 'LS.area.gamma.150' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in xy.coords(x, y): object 'HD.area.gamma.150' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in xy.coords(x, y): object 'para.error.gamma.150' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in xy.coords(x, y): object 'nonpara.error.gamma.150' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in xy.coords(x, y): object 'LSLW.error.gamma.150' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in xy.coords(x, y): object 'LS.error.gamma.150' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in xy.coords(x, y): object 'HD.error.gamma.150' not found}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in xy.coords(x, y): object 'para.inx.gamma.150' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in xy.coords(x, y): object 'nonpara.inx.gamma.150' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in xy.coords(x, y): object 'LSLW.inx.gamma.150' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in xy.coords(x, y): object 'LS.inx.gamma.150' not found}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in xy.coords(x, y): object 'HD.inx.gamma.150' not found}}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in xy.coords(x, y): object 'HD.inx.gamma.150' not found}}\end{kframe}
