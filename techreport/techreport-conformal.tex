...
\begin{verbatim}
##     user   system  elapsed 
## 1049.673    1.417  189.749
\end{verbatim}
\begin{alltt}
\hlstd{conformal.gamma} \hlkwb{<-} \hlstd{conformal.gamma}\hlopt{$}\hlstd{paraconfbin}
...
\begin{verbatim}
##    user  system elapsed 
## 561.389   1.320  96.774
\end{verbatim}
\begin{alltt}
\hlstd{conformal.gaussian} \hlkwb{<-} \hlstd{conformal.gaussian}\hlopt{$}\hlstd{paraconfbin}
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Timing stopped at: 0.096 0 0.095}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Timing stopped at: 0.371 0 0.372}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Timing stopped at: 0.001 0 0.002}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Timing stopped at: 0.002 0 0.001}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Timing stopped at: 0.006 0 0.006}}\end{kframe}
\end{knitrout}
