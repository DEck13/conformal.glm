...
mtext("coverage probability", side = 2, cex = 1, line = 2, outer = TRUE)

legend(0.30, 0.75, legend=c("parametric conformal", 
  "nonparametric conformal", "LSLW conformal", "LS conformal", 
  "HD region", "nominal coverage"), col=c("red", "green", "purple", 
  "black", "blue", "grey"), 
  lty=c(1,2,1,2,4,1), bty = "n", cex = 0.75)
@
\end{center}
...
of $\{0.5, 0.75, 1, 1.5, 2, 5, 7, 10, 12, 15, 20, 25\}$.  The LS and LSLW 
conformal prediction regions are fit using a cubic regression model.  
This model is simple and it fits this type of Gamma data better than a simple 
linear or quadratic regression model.  Note that as the shape parameter 
...
#plot.new()
#plot.window(xlim = c(0, 1), ylim = c(0.60, 1.00))
legend(0.15, 0.80, legend=c("parametric conformal", 
  "nonparametric conformal", "LSLW conformal", "LS conformal", 
  "HD region", "nominal coverage"), col=c("red", "green", "purple", 
  "black", "blue", "grey"), cex = 0.80,
  lty=c(1,2,1,2,4,1), bty = "n")
