...
axis(1); axis(2)
mtext("x", side = 1, cex = 1.5, line = 2, outer = TRUE)
mtext("coverage probability", side = 2, cex = 1.5, line = 2, outer = TRUE)
...
legend(0.40, 0.50, legend=c("parametric conformal", 
  "nonparametric conformal", "LSLW conformal", "LS conformal", 
  "HD region", "nominal coverage"), col=c("red", "green", "purple", 
  "black", "blue", "grey"), 
  lty=c(1,2,1,2,4,1), bty = "n")
...
mtext("log(shape)", side = 1, cex = 1.5, line = 2, outer = TRUE)
@
...
plot.window(xlim = c(log(min(shapes)), log(max(shapes))), 
  ylim = c(0.90, 0.98))
legend(0.25, 0.98, legend=c("parametric conformal", 
  "nonparametric conformal", "LSLW conformal", "LS conformal", 
  "HD region", "nominal coverage"), col=c("red", "green", "purple", 
  "black", "blue", "grey"), 
  lty=c(1,2,1,2,4,1), bty = "n")
...
mtext("x", side = 1, cex = 1.5, line = 2, outer = TRUE)
mtext("coverage", side = 2, cex = 1.5, line = 0, outer = TRUE)
@
